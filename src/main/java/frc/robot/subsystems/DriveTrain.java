...
public class DriveTrain extends Subsystem {
  ...
  public void setLeftMotors(double speed){
    motorLeft1.set(ControlMode.PercentOutput, -speed*RobotMap.SPEED_MULTIPLIER);
    motorLeft2.set(ControlMode.PercentOutput, -speed*RobotMap.SPEED_MULTIPLIER);
  }

  public void setRightMotors(double speed){
    motorRight1.set(ControlMode.PercentOutput, speed*RobotMap.SPEED_MULTIPLIER);
    motorRight2.set(ControlMode.PercentOutput, speed*RobotMap.SPEED_MULTIPLIER);
  }
